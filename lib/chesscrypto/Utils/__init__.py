...
from chesscrypto.Utils.lutils.ldata import MATE_VALUE, MATE_DEPTH
...
def prettyPrintScore(s, depth, format_mate=False):
    ...
    if s < MATE_VALUE - MATE_DEPTH:
        ...
        if format_mate:
            ...
            return "{pp}#{s:.0f}"  # Sign before sharp to be parsed in PGN
...
class wait_signal(chesscrypto.Future):
