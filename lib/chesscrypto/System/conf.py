...
from chesscrypto.System.prefix import addDataPrefix, addUserConfigPrefix, getDataPrefix
...
if getattr(sys, "frozen", False) and not MSYS2:
    ...
    default_book_path = os.path.join(base_path, "chesscrypto_book.bin")
else:
    default_book_path = os.path.join(addDataPrefix("chesscrypto_book.bin"))
