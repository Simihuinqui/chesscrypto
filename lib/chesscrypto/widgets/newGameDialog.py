...
from chesscrypto.Utils.IconLoader import load_icon, get_pixbuf
from chesscrypto.Utils.GameModel import GameModel
from chesscrypto.Utils.SetupModel import SetupModel, SetupPlayer
...
from chesscrypto.Utils.repr import localReprSign
from chesscrypto.Utils.lutils.ldata import FILE
...
from chesscrypto.System.protoopen import splitUri
from chesscrypto.System import conf
from chesscrypto.System.prefix import getDataPrefix, isInstalled, addDataPrefix
from chesscrypto.Players.engineNest import discoverer
from chesscrypto.Players.Human import Human
from chesscrypto.widgets import ImageMenu, mainwindow
from chesscrypto.widgets.prompttext import getUserTextDialog
from chesscrypto.widgets.BoardControl import BoardControl
from chesscrypto.Savers import fen, pgn
from chesscrypto.Savers.ChessFile import LoadingError
from chesscrypto.Variants import variants
from chesscrypto.Variants.normal import NormalBoard
from chesscrypto.perspectives import perspective_manager
from chesscrypto.perspectives.games import enddir
from chesscrypto.Utils.eco import find_opening_fen
...
class EnterNotationExtension(_GameInitializationMode):
    ...
    def _init(cls):
        ...
        flags = []
        if isInstalled():
            path = gettext.find("chesscrypto")
        else:
            path = gettext.find("chesscrypto", localedir=addDataPrefix("lang"))
        if path:
