...
from chesscrypto.System import conf, gstreamer, uistuff
from chesscrypto.Players.engineNest import discoverer
from chesscrypto.Utils import book
...
from chesscrypto.gfx import Pieces
from chesscrypto.widgets import mainwindow
from chesscrypto.widgets.Background import newTheme
...
def anal_combo_set_value(combobox, value, show_arrow_check, analyzer_type):
    ...
    from chesscrypto.widgets.gamewidget import widgets
...
class PanelTab:
    ...
    def __set_panel_active(self, panel, active):
        ...
        from chesscrypto.widgets.pydock import EAST
    ...
    def showit(self):
        from chesscrypto.widgets.gamewidget import showDesignGW

        showDesignGW()

    def hideit(self):
        from chesscrypto.widgets.gamewidget import hideDesignGW
    ...
    def __init__(self, widgets):
        ...
        def select_new_image(button):
            ...
            if new_image:
                ...
                from chesscrypto.widgets.TaskerManager import tasker
