...
from chesscrypto.perspectives.fics.ParrentListSection import (
    ParrentListSection,
    cmp,
    SEPARATOR,
    ACCEPT,
...
from chesscrypto.widgets.preferencesDialog import SoundTab
from chesscrypto.widgets.InfoBar import InfoBarMessage, InfoBarMessageButton
...
class Sidepanel(ParrentListSection):
    def load(self, widgets, connection, lounge):
        ...
        try:
            ...
            # Unknown signal name is raised by gtk < 2.10
            pass
    ...
    def onChallengeAdd(self, challenges, challenge):
        ...
        # Related: http://code.google.com/p/chesscrypto/issues/detail?id=206
