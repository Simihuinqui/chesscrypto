...
from chesscrypto.Utils.const import WHITE, BLACK, LOCAL, RUNNING, LECTURE
...
from chesscrypto.Savers import fen as fen_loader
...
class Sidepanel:
    ...
    def row_activated(self, widget, path, col):
        if path is None:
            ...
            from chesscrypto.widgets.TaskerManager import learn_tasker
...
def start_lecture_from(filename, index=None):
    ...
    white_name = black_name = "ChessCrypto"
