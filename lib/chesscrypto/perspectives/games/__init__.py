...
from chesscrypto.Savers.ChessFile import LoadingError
from chesscrypto.Savers import epd, fen, pgn, olv, png, database, html, txt
from chesscrypto.System import conf
from chesscrypto.System.Log import log
from chesscrypto.System.protoopen import isWriteable
from chesscrypto.System.uistuff import GladeWidgets
from chesscrypto.System.prefix import addUserConfigPrefix
from chesscrypto.Savers.pgn import parseDateTag
...
from chesscrypto.widgets import gamewidget, mainwindow, new_notebook
from chesscrypto.widgets.gamenanny import game_nanny
from chesscrypto.perspectives import Perspective, perspective_manager, panel_name
from chesscrypto.widgets.pydock.PyDockTop import PyDockTop
from chesscrypto.widgets.pydock.__init__ import CENTER, EAST, SOUTH
...
class Games(GObject.GObject, Perspective):
    ...
    async def generalStart(self, gamemodel, player0tup, player1tup, loaddata=None):
        ...
        for i, playertup in enumerate((player0tup, player1tup)):
            ...
            if type != LOCAL:
                ...
                # Until ChessCrypto has a proper profiles system, as discussed on the
    ...
    def saveGamePGN(self, game):
        ...
        try:
            ...
            # save to .scout
            from chesscrypto.Savers.pgn import scoutfish_path
            ...
            if index == 0:
                if ending not in enddir:
                    ...
                    d.format_secondary_text(
                        _(
                            "Was unable to save '%(uri)s' as ChessCrypto doesn't know the format '%(ending)s'."
                        )
    ...
    Please ensure that you have given the right path and try again."
            ...
            try:
                ...
                d.set_markup(
                    _("<big><b>ChessCrypto was not able to save the game</b></big>")
                )
                d.format_secondary_text(
