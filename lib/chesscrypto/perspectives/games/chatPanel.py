...
from chesscrypto.Utils.const import LOCAL
from chesscrypto.widgets.ChatView import ChatView
from chesscrypto.ic.ICGameModel import ICGameModel
from chesscrypto.ic.icc import DG_PLAYERS_IN_MY_GAME
...
class Sidepanel:
    ...
    def onMessageRecieved(self, player, text):
        sender = (
            "chesscryptobot" if player.gamemodel.offline_lecture else repr(self.opplayer)
        )
