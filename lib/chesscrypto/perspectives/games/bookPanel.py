...
from chesscrypto.System import conf, uistuff
...
from chesscrypto.Utils.eco import get_eco
from chesscrypto.Utils.IconLoader import get_pixbuf
from chesscrypto.Utils.logic import legalMoveCount
from chesscrypto.Utils.Move import Move, toSAN, toFAN, listToMoves
from chesscrypto.Utils.lutils.lmovegen import newMove
...
__about__ = _("Official ChessCrypto panel.")
...
class EndgameAdvisor(Advisor):
    def __init__(self, store, tv, boardcontrol):
        ...
        # deferred import to not slow down ChessCrypto starting up
        from chesscrypto.Utils.EndgameTable import EndgameTable
