...
a = Analysis(['lib/chesscrypto/Players/ChessCrypto.py'],
             pathex=[],
             hiddenimports=[],
             hookspath=None,
             runtime_hooks=None)
...
if platform.system() == "Windows":
    ...
    name += ".exe"
    console = False
    data = [('chesscrypto_book.bin', "..\\chesscrypto\\chesscrypto_book.bin", 'DATA')]
    ...
    console = True
    data = [('chesscrypto_book.bin', "%s/chesscrypto/chesscrypto_book.bin" % home, 'DATA')]
