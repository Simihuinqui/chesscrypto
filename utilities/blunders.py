...
"""
    ChessCrypto blunder finder script.
...
from chesscrypto.Players.Player import Player, TurnInterrupt, PlayerIsDead
from chesscrypto.System.protoopen import protoopen
from chesscrypto.System import SubProcess
from chesscrypto.Utils.GameModel import GameModel
from chesscrypto.Utils.const import *
from chesscrypto.Utils.Move import listToSan, toSAN
from chesscrypto.Savers import pgn
...
def queryAnalyzer(analyzers):
    print("ChessCrypto found the following analyzers on your system:")
...
def start(discoverer):
    ...
    print(
        "%s will now analyze the game between %s and %s with %d seconds per move."
