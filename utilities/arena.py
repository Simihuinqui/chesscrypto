...
"""
    ChessCrypto arena tournament script.
...
###############################################################################
from chesscrypto.System import Log
...
def findMatch():
    ...
    #       "chesscrypto" in discoverer.getName(engines[i]).lower() or
    #       "chesscrypto" in discoverer.getName(engines[j]).lower()]
    if not pos:
        return None, None
