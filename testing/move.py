...
from chesscrypto.Utils.const import GIVEAWAYCHESS, WILDCASTLECHESS, G1, G2, H2
from chesscrypto.Utils.Move import Move
from chesscrypto.Utils.lutils.LBoard import LBoard
from chesscrypto.Utils.lutils.lmove import (
    parseAN,
    parseSAN,
    parseFAN,
    toFAN,
...
from chesscrypto.Utils.lutils.lmovegen import genAllMoves, newMove
...
class MoveTestCase(unittest.TestCase):
    ...
    def test_paresSAN2(self):
        ...
        # If promotion piece is missing chesscrypto assumes queen promotion from 0.99.2
