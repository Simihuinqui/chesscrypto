...
from chesscrypto.Utils.const import WHITE, BLACK, LOCAL, F2, F3, E7, E5, G2, G4, D8, H4
...
from chesscrypto.perspectives.database.FilterPanel import formatted, TAG_FILTER, RULE
from chesscrypto.System.Log import log

log.logger.setLevel(logging.INFO)


base_name = "chesscrypto_test"
...
class DatabaseTests(unittest.TestCase):
    ...
    def test1(self):
        ...
        async def coro():
            ...
            # Now save our game to chesscrypto.pgn
            self.games_persp.saveGamePGN(gamemodel)

        loop.run_until_complete(coro())

    def test2(self):
        """Import world_matches.pgn into chesscrypto.pgn"""
    ...
    def test3(self):
        """Filter chesscrypto.pgn by Kasparov as white"""
